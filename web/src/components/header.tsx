  ...
  return (
    <div className="w-full max-w-3xl mx-auto flex items-center justify-between">
      ...
      <Dialog.Root>
        <Dialog.Trigger
          type="button"
          className="border border-green-500 font-semibold rounded-lg px-6 py-4 my-10 flex items-center gap-3 hover:border-green-300 transition-colors focus:outline-none focus:ring-2 focus:ring-green-700 focus:ring-offset-2 focus:ring-offset-background"
        >
